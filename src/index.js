...
// sqlite3 -csv -header movies.sqlite3 'select "imdbID" as id, "title", "genre","runtime","released","plot","cast","poster" from movies' | csvtojson --maxRowLength=0 > movies.json

// Firebase configuration
var Rebase = require('re-base')
var base = Rebase.createClass({
  apiKey: "AIzaSyD1nKN9K0EkJAigN4RqAPKtAhvm8zyvEQY",
  databaseURL: "https://buyflix-38f8f.firebaseio.com/",
...
var App = React.createClass({
  ...
  /*
  //Second render function was overriding this one; so I combined them
  render: function() {
    return (
      <div>
